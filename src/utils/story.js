...
export const story = {
  ...
  prologue: [
    ...
    `     A última esperança vem com a descoberta de exoplanetas, mundos orbitando estrelas distantes que poderiam ser habitáveis. Você faz parte da tripulação da nave Stella Explorer, liderada pela corajosa Capitã Aurora.`,
  ...
  chapters: [
    {
      ...
      conversations: [
        ...
        {
          title: 'Partida',
          description: `Dr. Orion, o cientista lider da tripulação, explica: "A nave Stella Explorer tem um sensor que detecta exoplanetas orbitando estrelas distantes. Se voce conseguir encontrar um, podemos encontrar um novo lar para a humanidade.`,
          backgroundImage: bg2,
    ...
    },
    {
      ...
      conversations: [
        ...
        },
        {
          ...
          description: `Você observa o gráfico de brilho e confirma: um gigante gasoso foi descoberto. Mas, infelizmente, este planeta não é habitável. Capitã Aurora sorri: “Ainda não é o que procuramos, mas estamos no caminho certo!”`,
          backgroundImage: bg7,
          characterImage: character1,
          minigame: 0,
        },
      ...
      conversations: [
        {
          ...
          description: `No próximo sistema, algo estranho acontece. A luz da estrela oscila entre o vermelho e o azul. Dr. Orion identifica rapidamente: "É o efeito Doppler! Algo está puxando esta estrela, provavelmente um planeta massivo."`,
        ...
        {
          title: 'Microlente Gravitacional',
          description: `Dr. Orion identifica rapidamente: "É uma microlente gravitacional! Isto significa que há algo massivo, provavelmente um exoplaneta, entre nós e aquela estrela."`,
          backgroundImage: bg10_2,
          characterImage: character2,
        },
        {
          title: 'Descobertas',
          description: `Você monitora os sinais e, após observação cuidadosa, descobre um novo planeta. Desta vez, é um planeta com atmosfera densa e sinais de água. Capitã Aurora fica entusiasmada: “Este pode ser o lugar que procuramos!” Mas ainda há muito para investigar.`,
